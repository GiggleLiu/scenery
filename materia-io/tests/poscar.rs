use materia_io::poscar;

const CU_DIRECT: &str = include_str!("../../materia/examples/data/cu.poscar");
const NACL_CART: &str = include_str!("../../materia/examples/data/nacl-cart.poscar");
const BAD_VASP4: &str = include_str!("../../materia/tests/data/bad-vasp4.poscar");
