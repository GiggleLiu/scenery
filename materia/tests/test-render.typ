...
#import "/src/real/figure.typ": crystal-scene, render
...
#render(crystal-scene(nacl), width: 8cm)
...
#render(
  crystal-scene(sto, bonds: ((elements: ("Ti", "O"), max: 2.2),), polyhedra: ("Ti",), labels: true),
...
#render(
  crystal-scene(mos2, supercell: (4, 4, 1), bonds: ((elements: ("Mo", "S"), max: 2.6),)),
  width: 10cm,
)
