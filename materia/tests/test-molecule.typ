...
// crystal-scene must produce sphere primitives and NO cell "edge" primitives.
#let scene = crystal-scene(water, bonds: auto)
...
// Two O-H bonds; crystal-scene splits each into two colour halves (two-tone),
