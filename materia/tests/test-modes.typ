...
#let default-scene = crystal-scene(water)
#let bas = crystal-scene(water, mode: "ball-and-stick")
...
#let cpk = crystal-scene(water, mode: "space-filling")
...
// "cpk" is a pure alias
#assert.eq(crystal-scene(water, mode: "cpk").prims, cpk.prims)
// a numeric radius scales the vdW spheres
#let cpk-half = crystal-scene(water, mode: "space-filling", radius: 0.5)
...
#let lic = crystal-scene(water, mode: "licorice")
...
#let single = crystal-scene(water, bond-color: luma(100))
...
#let lic-single = crystal-scene(water, mode: "licorice", bond-color: luma(100))
