...
#for case in fx.cases {
  ...
  // params input path — params->vectors must match materia's real-space orientation, so the
...
// --- structure dictionary input -> cubic answer ----------------------------
#let nacl = (vectors: ((5.64, 0, 0), (0, 5.64, 0), (0, 0, 5.64)))
#let adapted = reciprocal-vectors(nacl)
