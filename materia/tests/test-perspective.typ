...
#import "/src/real/figure.typ": crystal-scene, occlude, render
...
#let plain = crystal-scene(nacl, view: v)
#let explicit = crystal-scene(nacl, view: (..v, mode: "orthographic"))
...
#let per = crystal-scene(nacl, view: pv)
...
#assert(per.screen-bbox.at(2) - per.screen-bbox.at(0)
  > plain.screen-bbox.at(2) - plain.screen-bbox.at(0),
